...
cfg = {
    ...
    'min_sizes': [30, 60, 111, 162, 213, 264], # Min-size of default box
    'max_sizes': [60, 111, 162, 213, 264, 315], # Max-size of default box
    'aspect_ratios': [[2], [2, 3], [2, 3], [2, 3], [2], [2]] # Ratio of default box
}
